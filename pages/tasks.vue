...
.assignment-list { display: grid; }.assignment { display: grid; grid-template-columns: 38px minmax(220px, 1fr) 110px 150px; align-items: center; gap: 14px; width: 100%; padding: 14px 8px; color: inherit; text-align: left; background: transparent; border: 0; border-bottom: 1px solid #ebeef5; cursor: pointer; font: inherit; }.assignment:hover { background: #f5f7fa; }.assignment__icon { display: grid; width: 34px; height: 34px; color: #409eff; background: #ecf5ff; border-radius: 5px; place-items: center; }.assignment__main { display: flex; flex-direction: column; gap: 4px; }.assignment__main strong { font-size: 13px; }.assignment__main small, .assignment__due { color: #909399; font-size: 11px; }.assignment__due { display: flex; align-items: center; gap: 6px; }
.drawer-eyebrow { color: #909399; font-size: 11px; text-transform: uppercase; letter-spacing: .06em; }.drawer-eyebrow + h2 { margin: 4px 0 0; color: #303133; font-size: 20px; }.task-meta { display: flex; align-items: center; gap: 14px; }.task-meta span { display: flex; align-items: center; gap: 6px; color: #606266; font-size: 12px; }.task-description { margin: 24px 0; padding: 18px; background: #f5f7fa; border-radius: 6px; }.task-description h3 { margin: 0 0 8px; font-size: 13px; }.task-description p { margin: 0; color: #606266; font-size: 13px; line-height: 1.65; white-space: pre-wrap; }
