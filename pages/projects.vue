...
.project-row { display: grid; grid-template-columns: 42px minmax(240px, 1fr) 100px 110px 130px; align-items: center; gap: 14px; width: 100%; padding: 16px 10px; color: inherit; text-align: left; background: transparent; border: 0; border-bottom: 1px solid #ebeef5; cursor: pointer; font: inherit; }
.project-row:hover { background: #f5f7fa; }
.project-row__icon { display: grid; width: 38px; height: 38px; color: #409eff; background: #ecf5ff; border-radius: 6px; place-items: center; }
.project-row__main, .project-row__metric, .project-row__updated { display: flex; flex-direction: column; min-width: 0; gap: 4px; }
.project-row__main strong { font-size: 14px; }.project-row__main small { overflow: hidden; color: #909399; text-overflow: ellipsis; white-space: nowrap; }
.project-row__metric strong { font-size: 14px; }.project-row__metric small, .project-row__updated small { color: #909399; font-size: 11px; }.project-row__updated span { font-size: 12px; }
.drawer-eyebrow { color: #909399; font-size: 11px; text-transform: uppercase; letter-spacing: .06em; }.drawer-content h2, :deep(.el-drawer__header h2) { margin: 3px 0 0; color: #303133; font-size: 20px; }
.drawer-actions, .drawer-toolbar { display: flex; justify-content: flex-end; gap: 8px; }.drawer-toolbar { margin-bottom: 18px; }
.readme, .drawer-section { margin-bottom: 22px; border: 1px solid #e4e7ed; border-radius: 6px; }.section-title { display: flex; align-items: center; justify-content: space-between; gap: 8px; padding: 11px 14px; font-size: 12px; font-weight: 600; background: #f5f7fa; border-bottom: 1px solid #e4e7ed; }
.markdown-body { padding: 16px 20px; font-size: 13px; line-height: 1.65; }.markdown-body :deep(h1) { padding-bottom: 8px; font-size: 21px; border-bottom: 1px solid #e4e7ed; }.markdown-body :deep(a) { color: #409eff; }
.member-card, .task-summary { display: flex; align-items: center; gap: 10px; padding: 11px 14px; border-bottom: 1px solid #ebeef5; }.member-card:last-child, .task-summary:last-child { border-bottom: 0; }.member-main { display: flex; flex: 1; flex-direction: column; min-width: 0; gap: 2px; }.member-main strong { font-size: 13px; }.member-main small { color: #909399; font-size: 11px; text-transform: capitalize; }.task-summary { justify-content: space-between; font-size: 13px; }
